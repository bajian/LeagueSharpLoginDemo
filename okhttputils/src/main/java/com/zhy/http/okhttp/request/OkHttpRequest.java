...
public abstract class OkHttpRequest
{
    ...
    /**
     * 给OkHttpPostRequest继承后重写来回调进度用的，其他的类都没有实际用途
     * @param requestBody
     * @param callback
     * @return
     */
    ...
    {
        Log.d(OkHttpClientManager.TAG,"OkHttpRequest wrapRequestBody");
        return requestBody;
    }
    ...
    public static class Builder
    {
        ...
        /**
         * files(提交时候的名字，比如php中接收的$file = $_FILES['upload'];中的upload,文件)
